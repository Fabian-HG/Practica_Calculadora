function despliegue(){
    if(document.getElementById('cientifica') .style.display=='none') {document.getElementById('cientifica') .style.display=''}else{document.getElementById('cientifica') .style.display='none'}
}
function desplieguecon(){
    if(document.getElementById('conversiones') .style.display=='none') {document.getElementById('conversiones') .style.display=''}else{document.getElementById('conversiones') .style.display='none'}
}
...
function decimalBinario(){
    let decimalEnBinario = x.toString(2);
    pantalla.innerHTML=decimalEnBinario; 
}
function decimalOctal(){
let decimalEnOctal = x.toString(8);
     pantalla.innerHTML=decimalEnOctal; 
}
function decimalHexa(){
let decimalEnHexadecimal = x.toString(16);
     pantalla.innerHTML=decimalEnHexadecimal; 
}
function seno(){
    let res=Math.sin(x);
